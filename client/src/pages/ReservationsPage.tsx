    ...
    >
      <div className="flex justify-between items-center h-16 px-5 max-w-[1200px] mx-auto">
        ...
        <div className="hidden md:flex items-center gap-6 text-sm">
          {[
            { label: '공연', href: '/', active: false },
            { label: '티켓팅', href: '/', active: false },
            { label: '마이페이지', href: '/reservations', active: true },
            { label: '고객센터', href: '#', active: false },
            ...
            <DropdownMenuTrigger asChild>
              ...
              >
                ...
                {nickname ? (
                  ...
                  <span className={cn('w-12 h-3.5 rounded animate-pulse', dark ? 'bg-white/10' : 'bg-[#7c3aed]/10')} />
                )}
